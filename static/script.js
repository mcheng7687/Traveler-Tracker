...
//***************************************************************************//
// Get list of currency codes from https://www.exchangerate-api.com/docs/standard-requests
...
getExchangeRates(base).then(function(rates) {
    ...
    currency_codes.forEach( function (currency_code) {
        $(`.${currency_code}`).text(`1 ${base} = ${rates[currency_code]} ${currency_code}`);
    });
